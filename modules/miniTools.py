...
def init_parser():
    ...
    if not os.path.exists(result_file_path):
        with open(result_file_path, 'w') as file:
            ...
            writer.writerow(['Company', 'Site', 'Phone', 'Location', 'Category'])
...
def recording_company_info(company:str, country:str, phone:str, site:str, category:str=None):
    with open(result_file_path, 'a') as file:
        writer = csv.writer(file)
        writer.writerow([company, site, phone, country, category])
